"""
Django settings for STT_KR project.
...
WSGI_APPLICATION = 'STT_KR.wsgi.application'
...
# Development toggle: run heavy processing synchronously when Celery/Redis is unavailable
USE_CELERY = os.environ.get('USE_CELERY', '0') in ('1', 'true', 'True')